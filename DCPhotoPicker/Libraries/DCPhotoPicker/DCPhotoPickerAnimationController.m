//
//  DCPhotoPickerAnimationController.m
//  PhotoPicker
//
...
@interface DCPhotoPickerAnimationController()

@property (nonatomic, strong) DCPhotoPicker *viewController;
@property (nonatomic) BOOL presenting;

@end


@implementation DCPhotoPickerAnimationController
